...
import { AiOutlinePlayCircle, AiFillSetting,AiFillFileZip,AiOutlineSearch,AiOutlineFile,AiOutlineFileZip} from "react-icons/ai";
...
let mail=decode && decode.email?decode.email:decode.response.token
  ...
  //console.log("app response is ", appresponse[0])
  // console.log("app response is ", appresponse[1])
  ...
  function channelScript() {
    if (imageResponse !== undefined) {
      if (appresponse[1].function === "up") {
        ...
        dispatch(channelNetwork(platform, version, appName, channel,mail));
      }
      else {
  ...
  function stopScript() {
    if (imageResponse !== undefined) {
      if (appresponse[1].function === "chaincodeUpdate") {
  ...
  function removeScript() {
    if (imageResponse !== undefined) {
      if (appresponse[1].function === "down") {
        let platform = appresponse[0].platform
        let version = appresponse[0].verison
        ...
        <div className="side-menu" style={{ width: '15%', height: '80%' }}>
          <nav className="nav-style">
            ...
            {/* <button onClick={(e)=>generateScript(e)} className="check12" id="extraCss" style={{border:'none',backgroundColor:'#137EA9'}}>
              <AiFillSetting style={{ marginRight: "5px", fontSize: "18px" }} />  Template Library
            </button> */}
            {/* <span class="material-symbols-outlined">
file_copy
</span> */}
            {/* <Link to="/templatelibrary" onClick={stopScript} className="check12">
              <AiOutlineFile style={{ marginLeft: '3px', marginRight: "5px", fontSize: "18px",backgroundColor:"white"}} /> Template Library 
            </Link> */}
            <div id="but1" className='nbfscriptCss' onClick={butHandler1} ><LibraryBooksIcon  style={{ marginLeft: '3%', marginRight: '3%' }}/>Template Library</div>

            {/* <Link to="/genericapi" onClick={stopScript} className="check12">
              <BsPencilSquare className="" style={{ marginLeft: '3px', marginRight: "5px", fontSize: "18px", }} /> Generic API
            </Link> */}
            <div id="but2" className='nbfscriptCss' onClick={butHandler2} ><ApiIcon  style={{ marginLeft: '3%', marginRight: '3%' }}/>Generic API's</div>

            {/* <Link to="/templatestudio" onClick={stopScript} className="check12">
              <AiOutlineFileZip className="" style={{ marginLeft: '3px', marginRight: "5px", fontSize: "18px", }} />  Template Studio
            </Link> */}
                        <div id="but3" className='nbfscriptCss' onClick={butHandler3} ><FolderZipIcon  style={{ marginLeft: '3%', marginRight: '3%' }}/>Template Studio</div>
                        <div id="but4" className='nbfscriptCss' onClick={butHandler4} ><DnsIcon  style={{ marginLeft: '3%', marginRight: '3%' }}/>REST Api</div>
