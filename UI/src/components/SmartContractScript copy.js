...
const SmartContractScript = (props) => {
  ...
  let mail=decode.response.token
...
file_copy
            ...
            <Link to="/" onClick={startScript} className="check12">
              {/* <img src={startnetwork} alt="startlogo" className="border-0 bg-transparent" style={{backgroundColor:"transparent"}}/>  Start Network */}
              <AiOutlineFile style={{ marginLeft: '3px', marginRight: "5px", fontSize: "18px",opacity:1 }} /> Template Library 
            </Link>

            <Link to="/genericapi" onClick={channelScript} className="check12">
              <BsPencilSquare className="" style={{ marginLeft: '3px', marginRight: "5px", fontSize: "18px",opacity:1  }} /> Generic Api's 
            </Link>

            <Link to="/templatestudio" onClick={stopScript} className="check12">
              <AiOutlineFileZip className="" style={{ marginLeft: '3px', marginRight: "5px", fontSize: "18px",opacity:1 }} />  Template Studio
            </Link>
...
export default SmartContractScript;