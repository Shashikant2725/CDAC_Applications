...
import BCTLogsTable from "../NBFsuperAdminComponents/BCTLogsTable";
                        ...
                        >
                                <AppBar position="static" color="default">
                                        ...
                                        >
                                                ...
                                                <Tab label="Network Management" {...a11yProps(1)} />
      ...
      >
        ...
        <TabPanel value={value} index={2} dir={theme.direction}>
          Item Three
                                ...
                                <TabPanel value={value} index={0} style={{ height: '100%' }}>
                                        <div style={{ width: '100%', height: '67vh', display: 'flex' }}>
                                                <div style={{ width: '17%', height: '100%', backgroundColor: '#137EA9' }}>
                                                        <button style={{ width: '100%', height: '15%', border: 'none', marginTop: '5%', backgroundColor: 'transparent', color: 'white' }} onClick={butHandler1} id='but1'>NBA Admin</button>
                                                        <button style={{ width: '100%', height: '15%', border: 'none', marginTop: '5%', backgroundColor: 'transparent', color: 'white' }} onClick={butHandler2} id='but2'>Department Register</button>
                                                </div>
                                                <div style={{ width: '83%', height: '100%', paddingLeft: '3%' }}>
                                                

                                                        {NBAAdminTable && <BCTLogsTable />}
                                                        {DRTable && <Department />}
                                ...
                                <TabPanel value={value} index={1} dir={theme.direction}>
                                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" style={{ marginBottom: '15px' }} />
                                        <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" style={{ marginBottom: '15px' }} />
                                        <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Confirm Password" style={{ marginBottom: '15px' }} />
