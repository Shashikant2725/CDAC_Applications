...
const handleChange1 = (index, evnt, id)=>{
              ...
              <div className="col-sm-8">
                {
                  ...
                  <input type="text"  onChange={(evnt)=>handleChange(index, evnt,  id="publicMandatory")} value={data.publicMandatoryField} name="publicMandatoryField" className="form-control"  placeholder="Public Mandatory Field" required/>
                  </div>
                  </div>
                  <div className="col">
                  <div className="form-group">
                  <input type="text"  onChange={(evnt)=>handleChange(index, evnt,  id="publicMandatory")} value={data.publicMandatoryData} name="publicMandatoryData" className="form-control"  placeholder="Public Mandatory Data" required/>
                  </div>
                  </div>
                 
                  <div className="col">
                  <div className="form-group">
                  <input type="text"  onChange={(evnt)=>handleChange(index, evnt,  id="publicMandatory")} value={data.publicDataField} name="publicDataField" className="form-control"  placeholder="PublicDataField" required/>
                  </div>
                  </div>
                  <div className="col">
                  <div className="form-group">
                  <input type="text"  onChange={(evnt)=>handleChange(index, evnt,  id="publicMandatory")} value={data.publicData} name="publicData" className="form-control"  placeholder="Public Data" required/>
                  </div>
                  </div>
                    ...
                    inputFields1.map((data, index, id="privateMandatory")=>{
                        ...
                        return(
                          <div className="row my-3" key={index}>
                             <div className="col">
                  <div className="form-group">
                  <input type="text"  onChange={(evnt)=>handleChange1(index, evnt,  id="privateMandatory")} value={data.privateMandatoryField} name="privateMandatoryField" className="form-control"  placeholder="Private Mandatory Field" required/>
                  </div>
                  </div>
                  <div className="col">
                  <div className="form-group">
                  <input type="text"  onChange={(evnt)=>handleChange1(index, evnt,  id="privateMandatory")} value={data.privateMandatoryData} name="privateMandatoryData" className="form-control"  placeholder="Private Mandatory Data" required/>
                  </div>
                  </div>

                  <div className="col">
                  <div className="form-group">
                  <input type="text"  onChange={(evnt)=>handleChange1(index, evnt,  id="privateMandatory")} value={data.privateDataField} name="privateDataField" className="form-control"  placeholder="PrivateDataField" required/>
                  </div>
                  </div>
                  <div className="col">
                  <div className="form-group">
                  <input type="text"  onChange={(evnt)=>handleChange1(index, evnt,  id="privateMandatory")} value={data.privateData} name="privateData" className="form-control"  placeholder="Private Data" required/>
                  </div>
                  </div>
