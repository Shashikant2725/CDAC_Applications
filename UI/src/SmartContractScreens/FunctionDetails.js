  ...
  return (
    ...
    <div>
      ...
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        ...
        <Grid item xs={2} style={{marginTop:"-1%",marginLeft:"43%"}}>
          <Item>
...
{e.FunctionName}
        ...
        title={
          <React.Fragment>
            <Typography color="inherit">Following Functions are there based on Stakeholder</Typography>
          
        {DomainNamess.map(detail => (
            <ul>
              <li>{detail.FunctionName}</li>
             </ul>
        ))}
        ...
        placement="top-start"
      >
        <Button><InfoIcon style={{marginLeft:"-1px"}} /></Button>
      </HtmlTooltip>
