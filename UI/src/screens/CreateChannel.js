...
const CreateChannel = (props) => {
  const data = useSelector((store) => store.start_channel);
  const { error, response, loading } = data;

  let imageBase64 = localStorage.getItem("base64code")

  let startTime = localStorage.getItem("channelStartTime")
      ...
      <div style={{
        ...
        <div className="rightScript">
          ...
          <div className="rightMainScript">
            ...
            Create Channel
            {/* {loading && <div><ThreeDots color="#00BFFF" height={60} width={80} /></div>} */}
