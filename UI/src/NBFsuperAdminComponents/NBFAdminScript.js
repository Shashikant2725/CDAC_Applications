...
export default function DepartmentDashboardScript() {
        ...
        function butHandler7(){
                history("/addFunctions")
                
        }

        function butHandler8(){
                history("/assetCreation")
        ...
        return (
                <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', paddingTop: '3%' }}>
                        ...
                        <div id="but5" className='nbfscriptCss' onClick={butHandler5} > <AppRegistrationIcon  style={{ marginLeft: '3%', marginRight: '2%' }}/> Register Domain</div>
                        <div id="but6" className='nbfscriptCss' onClick={butHandler6} > <PersonAddAlt1Icon  style={{ marginLeft: '3%', marginRight: '2%' }}/> Add Stakeholders</div>
                        <div id="but7" className='nbfscriptCss' onClick={butHandler7} ><PlaylistAddIcon  style={{ marginLeft: '3%', marginRight: '2%' }}/>Add Functions</div>
                        {/* <div id="but8" className='nbfscriptCss' onClick={butHandler8} ><AddBoxIcon />Create Asset</div>
                        <div id="but9" className='nbfscriptCss' onClick={butHandler9} ><TransferWithinAStationIcon />Transfer Ownership</div> */}
