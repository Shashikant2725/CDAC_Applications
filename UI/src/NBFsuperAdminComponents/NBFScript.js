...
const UploadChaincodeScript = (props) => {
        ...
        return (
                <div style={{ width: '100%', height: '100%', backgroundColor: '#137EA9' }}>
                        <nav className="nav-style">
                                <Link to="/" className="check12"><img src={upload} width={18}></img>NBA Admin</Link>
                                <Link to="/" className="check12"><img src={rotate} width={18}></img>Department Register</Link>
                        </nav>
                </div>
        );
};
