    ...
    const swaggerFile = require("./swagger_output.json");
        ...
        console.log('Server listening on 10.244.3.187'); `;
          ...
          async function foo(i) {
            ...
            for(var j=0;j<ccbodyrequest.data.PostCode.length;j++)
            {
              chaincodebody1 = ccbodyrequest.data.PostCode[j].LogicBody.toString();
            ...
            for(var j=0;j<ccbodyrequest.data.GetCode.length;j++)
            {
              chaincodebody2 = ccbodyrequest.data.GetCode[j].LogicBody.toString()
            ...
            for(var j=0;j<ccbodyrequest.data.DeleteCode.length;j++)
            {
              chaincodebody3 = ccbodyrequest.data.DeleteCode[j].LogicBody.toString()
            ...
            for(var j=0;j<ccbodyrequest.data.PutCode.length;j++)
            {
              chaincodebody4 = ccbodyrequest.data.PutCode[j].LogicBody.toString()
            ...
            for(var j=0;j<ccbodyrequest.data.PatchCode.length;j++)
            {
              chaincodebody5 = ccbodyrequest.data.PatchCode[j].LogicBody.toString()
