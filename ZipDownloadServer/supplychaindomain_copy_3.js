...
//////////////////----------------FragileGoods Ends here-------------------//////////////

//////////////////----------------PerishibleGoods starts here-------------/////////////
...
/////////////////-----------------PerishibleGoods ends hear---------------/////////////

/////////////////-----------------perchaseOrderFailure starts here---------////////////
...
exports.PurchaseOrderFailure= async(req,res)=>{
    try {
        ...
        await contract.submitTransaction(
            ...
            req.headers.actualdeliverydate,
            req.headers.costofgoods,
            req.headers.maxfailures,
            req.headers.previousfailures,
            req.headers.latefee,
            req.headers.amountfailurecompensation
...
////////////////------------------perchaseOdrerFailure ends here-----------////////////
...
/////////////////--------------Query All Details Starts here--------------///////////////////////////////

exports.QueryAllDetails= async(req,res)=>{
    try {
        const username = req.headers.username
        // load the network configuration
        const ccpPath = path.resolve(__dirname, '..', '..', 'test-network', 'organizations', 'peerOrganizations', 'org1.example.com', 'connection-org1.json');
...
////////////////////--------------Query All Details Function ends here-----------------/////////////////////