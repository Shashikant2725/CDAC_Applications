    ...
    try {
      ...
      if (action === 'center') {
        ...
        return context.getState([Address]).then(function (stateKeyValueAddress) {
          ...
          console.log("key value is :"+alldata.length); 
          
          return _setEntry(context, Address,alldata);
        });
      } 
      else if (action === 'hospitalinfo') {
      ...
      else if (action === 'fetchclientdata') {
      ...
      else if (action === 'patientverification') {
      ...
      else if (action === 'cashlessclaimtoic') {
        ...
        return context.getState([Address]).then(function (stateKeyValueAddress) {
          ...
          //  alldata[c]={objectData};
           ...
           console.log("key value is :"); 
          return _setEntry(context, Address,objectData);
        });
      }
      else if (action === 'claimsettlementtohospital') {
      ...
      else if (action === 'reimbursementtoIC') {
      ...
      else if (action === 'claimverification') {
      ...
      else if (action === 'claimsettlementtopolicyholder') {
