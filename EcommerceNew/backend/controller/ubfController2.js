...
const {NodeFunction} = require('../models/ubfAdminModel');
...
const updateNodeFunction = asyncHandler(async (req,res)=>{
    ...
    const getAllNodeFunctions = asyncHandler(async(req,res)=>{
...
module.exports = { Create:createNodeFunction,GetAllNodeFunctions:getAllNodeFunctions,DeleteNodeFunction:deleteNodeFunction,UpdateNodeFunction:updateNodeFunction,GetNodeFunction:getNodeFunction};
